                ...
                <div class="dropdown">
                    <div id="myDropdown" class="dropdown-content">
                        ...
                        <form action="${pageContext.request.contextPath}/ServletGraphic" method="post">
                            ...
                            <select class="form-control" id="carportWidth" required name="carportWidth"
                                    title="carportWidth">
                            ...
                            <select class="form-control" id="carportLength" required name="carportLength"
                            ...
                            <input type="text" class="form-control" disabled value="${sessionScope.user.address}"
                                   placeholder="Adresse"
                            ...
                            <c:if test="${sessionScope.user == null}">
                                <button name="næstelogind" id="næstelogind" value="submit"
                                        style="width:25%; font-weight: bold" formaction="login.jsp">
                                    Log ind
                                </button>
                            </c:if>
